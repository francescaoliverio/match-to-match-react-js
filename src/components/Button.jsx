...
const BASE_STYLES = "flex items-center justify-center gap-2.5 px-5 py-2.5 rounded-full w-fit font-bold cursor-pointer disabled:cursor-default";
...
const VARIANT_STYLES = {
  ...
  transparent: "text-ink hover:text-tertiary disabled:text-grey-light bg-transparent",
};
